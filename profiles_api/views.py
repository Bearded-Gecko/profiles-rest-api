...
class HelloApiView(APIView):
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            return Response(
            serializer.errors, #dictionary of all the errors from the validation rules applied to the serializer
...
class HelloViewSet(viewsets.ViewSet):
    ...
    def retrieve(self, request, pk=None): #retrieve function is for retrieving a specific object in our viewset
           """Handle getting an object by its ID"""
           return Response({'http_method': 'GET'})

    def update(self, request, pk=None): #maps to an HTTP put
        """Handle updating an object"""
...
class UserProfileFeedViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = (permissions.UpdateOwnStatus, IsAuthenticated) #user must be authenticated to performan any request that is not read request
